          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" action="" method="post">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="judul_skripsi" class="form-control" id="judul_skripsi" placeholder="Masukkan Judul">
                  </div>
                </div>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" name="tahun" class="form-control" id="tahun" placeholder="Masukkan Tahun Terbit Paper">
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <textarea class="form-control" name="abstrak" id="abstrak" rows="15" placeholder="Masukkan Abstrak"></textarea>
                </div>
                </div>
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="kata_kunci" class="form-control" id="katakunci" placeholder="Masukkan Kata Kunci Abstrak">
                  </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <textarea class="form-control" name="dapus" id="dapus" rows="15" placeholder="Masukkan Daftar Pustaka"></textarea>
                </div>
                </div>
              ...
              <div class="box-footer clearfix">
                <button type="" class="btn btn-default pull-left"><a href="daftarpaper">Lihat Tabel</a></button>
